...
contract ververvPreSale {
    ververv public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 4000000000000;
    uint constant public minSaleAmount = 50000;

    function ververvPreSale(
        ververv _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = ververv(_token);
